...
resource "iosxr_router_bgp" "router_bgp_rrpce" {
  depends_on    = [iosxr_router_bgp_address_family.ipv4-unicast, iosxr_router_bgp_address_family.ipv6-unicast, iosxr_router_bgp_address_family.vpnv4-unicast, iosxr_router_bgp_address_family.vpnv6-unicast, iosxr_router_bgp_address_family.l2vpn-evpn, iosxr_router_bgp_neighbor_group.neighbor_group_rr_client]
